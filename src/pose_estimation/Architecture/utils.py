...
def motion_matrix_to_pose7(matrix: torch.Tensor) -> torch.Tensor:
    """
    Convert 4x4 motion matrix to a 7-element pose vector.

    Args:
        matrix: Motion matrices of shape (batch, 4, 4)

    Returns:
        Pose vectors of shape (batch, 7) containing translation and quaternion
    """
